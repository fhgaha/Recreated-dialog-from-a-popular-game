...
const Data := preload('character_working_class_woman_state.gd')

var state: Data = load('res://game/characters/working_class_woman/character_working_class_woman.tres')
...
#	await C.player.say("Hi!")
	D.WorkingClassWomanFirst.start()
...
func _on_right_click() -> void:
	...
	await C.player.face_clicked()
	await C.player.say("A sturdy looking woman humming to herself")
	pass
